...
contract FluxAggregator is AggregatorV2V3Interface, Owned {
    ...
    HotspotOracleTokenInterface public HotspotOracleToken;
     ...
     * reserve of RESERVE_ROUNDS * oracleCount() HSO earmarked for payment to
     ...
     * @param _paymentAmount The amount paid of HSO paid to each oracle per submission, in wei (units of 10⁻¹⁸ HSO)
    ...
    constructor(
        ...
        HotspotOracleToken = HotspotOracleTokenInterface(_HSO);
    ...
    /**
     * @notice recalculate the amount of HSO available for payouts
     */
    function updateAvailableFunds() public {
        Funds memory funds = recordedFunds;

        uint256 nowAvailable =
            HotspotOracleToken.balanceOf(address(this)).sub(funds.allocated);
    ...
    /**
     * @notice query the available amount of HSO for an oracle to withdraw
     */
    ...
    /**
     * @notice transfers the oracle's HSO to another address. Can only be called
     * by the oracle's admin.
     * @param _oracle is the oracle whose HSO is transferred
     * @param _recipient is the address to send the HSO to
     * @param _amount is the amount of HSO to send
     */
    function withdrawPayment(
        ...
        // Safe to downcast _amount because the total amount of HSO is less than 2^128.
        ...
        assert(HotspotOracleToken.transfer(_recipient, uint256(amount)));
    }

    /**
     * @notice transfers the owner's HSO to another address
     * @param _recipient is the address to send the HSO to
     * @param _amount is the amount of HSO to send
     */
        ...
        onlyOwner()
    {
        ...
        require(
            HotspotOracleToken.transfer(_recipient, _amount),
    ...
    /**
     * @notice called through HSO's transferAndCall to update available funds
